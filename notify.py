...
if __name__ == '__main__':
    ...
    # 通用客户的任务
    schedule.every().friday.at('10:03').do(manager.query_house_info, config.ggd_config_init())
    schedule.every().friday.at('10:13').do(manager.query_house_info, config.gs_config_init())
    schedule.every().friday.at('10:23').do(manager.query_house_info, config.yjw_config_init())
